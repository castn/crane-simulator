...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def update_plot(self):
        ...
        plotter_manager = PlotterManager(self.axial_coloring.isChecked(), self.cmap, self.cmap, self.u_canvas.fig,
                                         self.o_canvas.fig)
        ...
        plotter_manager.update_unoptimized_plots(nodes, deformed_nodes, beams, self.area_per_rod, self.N)
