...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def update_debug_tree_widget(self, nodes, beams, def_nodes, area_per_rod, o_area_per_rod):
        ...
        tree_items = [create_tree_item(nodes, "Coordinates of Nodes", ""),
                      ...
                      create_tree_item(area_per_rod, "Cross sectional area per Rod (Unoptimized)", "m\u00B2"),
                      create_tree_item(o_area_per_rod, "Cross sectional area per Rod (Optimized)", "m\u00B2")]
    ...
    def apply_configuration(self):
        ...
        if self.check_config():
            ...
            self.update_plot()
            nodes, beams = crane.get_crane()
            self.update_debug_tree_widget(nodes, beams, nodes + self.deformation, self.area_per_rod,
                                          self.optim_area_per_rod)
            self.update_info()

            self.update_fem_tree_widget(self.axial_forces, self.reaction_forces, self.deformation)
