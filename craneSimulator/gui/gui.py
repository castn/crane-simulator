...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.create_actions()
        # Set tree widgets
        self.fem_unoptimized_treeWidget.setColumnCount(1)
        self.fem_unoptimized_treeWidget.setHeaderLabel("FEM values for unoptimized crane")
        self.fem_optimized_treeWidget.setColumnCount(1)
        self.fem_optimized_treeWidget.setHeaderLabel("FEM values for optimized crane")
        self.debug_unoptimized_treeWidget.setColumnCount(1)
        self.debug_unoptimized_treeWidget.setHeaderLabel("Debug values for unoptimized crane")
        self.debug_optimized_treeWidget.setColumnCount(1)
        self.debug_optimized_treeWidget.setHeaderLabel("Debug values for optimized crane")
        self.comparison_base_treeWidget.setColumnCount(1)
        self.comparison_base_treeWidget.setHeaderLabel("Comparison base (old)")
        self.current_treeWidget.setColumnCount(1)
        self.current_treeWidget.setHeaderLabel("Current crane (new)")
        ...
        self.current_as_comparison_base.clicked.connect(self.create_comparison)
    ...
    def set_values_debug_treeWidgets(self):
        ...
        self.debug_unoptimized_treeWidget.clear()
        ...
        self.debug_unoptimized_treeWidget.insertTopLevelItems(0, optim_tree_items)

        self.debug_optimized_treeWidget.clear()
        optim_tree_items = [create_tree_item(self.nodes, "XYZ-Coordinates of undeformed Nodes", ""),
        ...
        self.debug_optimized_treeWidget.insertTopLevelItems(0, optim_tree_items)
    ...
    def update_diff_treeWidget(self):
        self.comparison_base_treeWidget.clear()
        ...
        current_tree_items = [create_tree_item(self.nodes, "XYZ-Coordinates of undeformed Nodes", ""),
                              ...
                              create_tree_item(self.beams, "Nodes per Beam", ""),
                              create_tree_item(self.optim_area_per_rod, "Cross sectional area per Rod", "m\u00B2")]
        self.current_treeWidget.insertTopLevelItems(0, current_tree_items)
        ...
        if not type(self.comparison_base) == type(None):  # Might need to check all types in list below
            comparison_base_tree_items = [create_tree_item(self.base_nodes, "XYZ-Coordinates of undeformed Nodes", ""),
                                          ...
                                          create_tree_item(self.base_optim_area_per_rod, "Cross sectional area per Rod",
                                                           "m\u00B2")]
            self.comparison_base_treeWidget.insertTopLevelItems(0, comparison_base_tree_items)
    ...
    def add_new_plots(self):
        ...
        self.unoptimized_plot_layout.addWidget(self.unoptim_toolbar)
        self.unoptimized_plot_layout.addWidget(self.unoptim_canvas)
        self.optimize_plot_layout.addWidget(self.optim_toolbar)
        self.optimize_plot_layout.addWidget(self.optim_canvas)
        self.diff_plot_layout.addWidget(self.diff_toolbar)
        self.diff_plot_layout.addWidget(self.diff_canvas)
    ...
    def remove_current_plots(self):
        ...
        if not self.diff_no_data_label.isHidden():
            self.diff_no_data_label.hide()
    ...
    def remove_current_widget(self, widget):
        if not type(widget) == type(None):
            self.unoptimized_plot_layout.removeWidget(widget)
