...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.current_as_comparison_base = QtWidgets.QPushButton(parent=self.crane)
        self.current_as_comparison_base.setObjectName("current_as_comparison_base")
        ...
        self.unoptimized_no_data_label = QtWidgets.QLabel(parent=self.unoptimizedPlot)
        self.unoptimized_no_data_label.setObjectName("unoptimized_no_data_label")
        self.unoptimized_plot_layout.addWidget(self.unoptimized_no_data_label, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.optimized_no_data_label = QtWidgets.QLabel(parent=self.optimizedPlot)
        self.optimized_no_data_label.setObjectName("optimized_no_data_label")
        self.optimize_plot_layout.addWidget(self.optimized_no_data_label, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.verticalLayout_7.addLayout(self.optimize_plot_layout)
        self.plotBox.addTab(self.optimizedPlot, "")
        self.diff_plot = QtWidgets.QWidget()
        self.diff_plot.setObjectName("diff_plot")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.diff_plot)
        self.verticalLayout.setObjectName("verticalLayout")
        self.diff_plot_layout = QtWidgets.QVBoxLayout()
        self.diff_plot_layout.setObjectName("diff_plot_layout")
        self.diff_no_data_label = QtWidgets.QLabel(parent=self.diff_plot)
        self.diff_no_data_label.setObjectName("diff_no_data_label")
        self.diff_plot_layout.addWidget(self.diff_no_data_label, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.fem_output)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.fem_unoptimized_treeWidget = QtWidgets.QTreeWidget(parent=self.fem_output)
        self.fem_unoptimized_treeWidget.setObjectName("fem_unoptimized_treeWidget")
        self.fem_unoptimized_treeWidget.headerItem().setText(0, "1")
        self.horizontalLayout_3.addWidget(self.fem_unoptimized_treeWidget)
        self.fem_optimized_treeWidget = QtWidgets.QTreeWidget(parent=self.fem_output)
        self.fem_optimized_treeWidget.setObjectName("fem_optimized_treeWidget")
        self.fem_optimized_treeWidget.headerItem().setText(0, "1")
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.debug_output)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.debug_unoptimized_treeWidget = QtWidgets.QTreeWidget(parent=self.debug_output)
        self.debug_unoptimized_treeWidget.setObjectName("debug_unoptimized_treeWidget")
        self.debug_unoptimized_treeWidget.headerItem().setText(0, "1")
        ...
        self.debug_unoptimized_treeWidget.header().setSortIndicatorShown(False)
        ...
        self.debug_optimized_treeWidget = QtWidgets.QTreeWidget(parent=self.debug_output)
        self.debug_optimized_treeWidget.setObjectName("debug_optimized_treeWidget")
        self.debug_optimized_treeWidget.headerItem().setText(0, "1")
        self.horizontalLayout_2.addWidget(self.debug_optimized_treeWidget)
        self.tabWidget.addTab(self.debug_output, "")
        self.diff_output = QtWidgets.QWidget()
        self.diff_output.setObjectName("diff_output")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.diff_output)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.comparison_base_treeWidget = QtWidgets.QTreeWidget(parent=self.diff_output)
        self.comparison_base_treeWidget.setObjectName("comparison_base_treeWidget")
        self.comparison_base_treeWidget.headerItem().setText(0, "1")
        self.horizontalLayout_4.addWidget(self.comparison_base_treeWidget)
        self.current_treeWidget = QtWidgets.QTreeWidget(parent=self.diff_output)
        self.current_treeWidget.setObjectName("current_treeWidget")
        self.current_treeWidget.headerItem().setText(0, "1")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.current_as_comparison_base.setText(_translate("MainWindow", "Make current as comparison base"))
        ...
        self.unoptimized_no_data_label.setText(_translate("MainWindow", "No available data. Click Apply to plot the crane defined via the Options"))
        self.plotBox.setTabText(self.plotBox.indexOf(self.unoptimizedPlot), _translate("MainWindow", "Unoptimized"))
        self.optimized_no_data_label.setText(_translate("MainWindow", "No available data. Click Apply to plot the crane defined via the Options"))
        self.plotBox.setTabText(self.plotBox.indexOf(self.optimizedPlot), _translate("MainWindow", "Optimized"))
        self.diff_no_data_label.setText(_translate("MainWindow", "No available data. Click Apply to plot the crane defined via the Options"))
        self.plotBox.setTabText(self.plotBox.indexOf(self.diff_plot), _translate("MainWindow", "Diff"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.diff_output), _translate("MainWindow", "Diff"))
