...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmap_label.setText(_translate("MainWindow", "CMAP"))
        self.cmap.setItemText(0, _translate("MainWindow", "copper"))
        self.cmap.setItemText(1, _translate("MainWindow", "hot"))
        self.cmap.setItemText(2, _translate("MainWindow", "viridis"))
        self.cmap.setItemText(3, _translate("MainWindow", "plasma"))
        self.cmap.setItemText(4, _translate("MainWindow", "inferno"))
        self.cmap.setItemText(5, _translate("MainWindow", "magma"))
        self.cmap.setItemText(6, _translate("MainWindow", "cividis"))
        self.cmap.setItemText(7, _translate("MainWindow", "spring"))
        self.cmap.setItemText(8, _translate("MainWindow", "summer"))
        self.cmap.setItemText(9, _translate("MainWindow", "autumn"))
        self.cmap.setItemText(10, _translate("MainWindow", "winter"))
        self.cmap.setItemText(11, _translate("MainWindow", "cool"))
        self.cmap.setItemText(12, _translate("MainWindow", "Wistia"))
        self.cmap.setItemText(13, _translate("MainWindow", "afmhot"))
        self.cmap.setItemText(14, _translate("MainWindow", "gist_heat"))
